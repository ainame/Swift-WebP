...
public struct WebPConfig {
    ...
    static public func preset(_ preset: Preset, quality: Float) -> WebPConfig {
    ...
    internal init?(rawValue: CWebP.WebPConfig) {
        ...
        pad = (Int(rawValue.pad.0), Int(rawValue.pad.1), Int(rawValue.pad.2))
    }
    ...
    internal var rawValue: CWebP.WebPConfig {
        ...
        return CWebP.WebPConfig(
            ...
            exact: Int32(exact),
            pad: (UInt32(pad.0), UInt32(pad.1), UInt32(pad.2))
        )
    }
